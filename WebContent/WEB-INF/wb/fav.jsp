...
int cc = Integer.parseInt(user.getProp("favourites_count")+"");
...
$(function(){
	...
	pageNav.fn = function(p,pn){
		//按页载入消息
		$.getJSON("<%=prefix %>/favor/list?p="+p+"&pz=10&uid=<%=userId%>&r="+new Date(),function(data){
			var s = "";
...
<% out.println(WBJSPCacheOut.out("@foot_fav")); %>